...
<head>
    ...
    <link rel="shortcut icon" href="resources/favicons/android-chrome-256x256.png">
...
<body>
    ...
    <header>
       <nav> 
           <div class="row">
               <img src="resources/images/logo-white.png" alt="Omnifood log" class="logo">
               <img src="resources/images/logo.png" alt="Omnifood log" class="logo-black">
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2 steps-box">
                ...
                <div class="works-step">
                    <div>2</div>
                    <p>
                        Order your delicious meal by calling us!
                    </p>
                </div>
                <div class="works-step">
                    <div>3</div>
    ...
    <section class="section-cities" id="cities">
        ...
        <div class="row js--wp-3">
            ...
            <div class="col span-1-of-4 box">
               <img src="resources/images/san-francisco.jpg" alt="Lisbon">
               <h3>San Francisco</h3>
               <div class="city-feature">
                   <i class="icon ion-ios-person icon-small"></i>
                    3700+ happy eaters
    ...
    <section class="section-form" id="form" id="contact">
        <div class="row">
    ...
    <footer>
        <div class="row">
            <p>
                Copyright &copy; by Omnifood. All rights reserved.
            </p>
        </div>
    </footer>
